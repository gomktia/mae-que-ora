  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-sand text-brown flex flex-col">
        ...
        {/* Hero Section */}
        <section className="relative pt-6 pb-8 sm:pt-12 sm:pb-16 px-4 text-center overflow-hidden flex flex-col items-center">
        ...
        {mostrarOferta && (
          <div className="animate-fade-in-up">
            ...
            {/* DESTAQUE AVÓS - Mensagem especial para avós */}
            <section className="relative overflow-hidden scroll-animate transition-all duration-1000 py-16 bg-white">
              <div className="max-w-5xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                  <div className="group rounded-3xl overflow-hidden shadow-2xl border-2 border-bronze/20 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_-12px_rgba(163,120,56,0.3)]">
                    <div className="relative w-full aspect-[3/4]">
                      <Image
                        src="/assets/landingpage/maeevo.jpeg"
                        alt="Avó orando com netos"
                        layout="fill"
                        objectFit="cover"
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="bg-gradient-to-br from-sand/50 to-white p-8 sm:p-10 rounded-3xl border-2 border-bronze/20 shadow-lg relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-2 h-full bg-gradient-to-b from-bronze to-[#C89B55]"></div>
                      <h3 className="font-[family-name:var(--font-playfair)] text-brown text-2xl sm:text-3xl md:text-4xl font-black leading-tight mb-6">
                        A responsabilidade espiritual <span className="text-bronze">não termina</span> quando os filhos crescem.
                      </h3>
                      ...
                      <p className="font-[family-name:var(--font-inter)] text-brown text-lg leading-relaxed font-bold">
                        Essa geração precisa da sua oração. <span className="text-bronze">Não fique de fora dessa missão.</span>
                      </p>
                    </div>
                  </div>
                </div>
